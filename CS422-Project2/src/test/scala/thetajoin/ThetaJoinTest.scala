...
class ThetaJoinTest extends FlatSpec {  // TODO Original: Bring back !
// class ThetaJoinTest {
  ...
  test
    ...
    def test() {
       ...
       val input1 = new File(getClass.getResource(inputFile1).getFile).getPath  //TODO Original
       val input2 = new File(getClass.getResource(inputFile2).getFile).getPath  //TODO Original

        val input1 = "src/test/resources/input1_2K.csv"
        val input2 = "src/test/resources/input2_2K.csv"
